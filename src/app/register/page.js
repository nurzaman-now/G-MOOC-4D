...
const Register = () => {
    ...
    const [isButtonImage, setIsButtonImage] = useState(true);
    const maxImages = 20;
                    ...
                    <form className='mx-4 flex flex-col items-center gap-[16px] md:mx-0 ' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {isCameraOpen ? (
                            <Popup
                                ...
                                <div className='relative rounded-lg bg-white p-5 shadow-lg'>
                                    ...
                                    <div className='mt-4 flex flex-col items-center'>
                                        <h3 className='mb-2 text-xl font-semibold'>Memindai Wajah Anda</h3>
                                        <div>
                                            <h1 className='relative mb-2 text-center font-semibold '>
                                                Tunggu beberapa saat, hingga kamera keluar sendiri
                                            </h1>
                                        </div>
                                        <div>
                            ...
                            <div>
                                <h1 className='relative mb-2 text-center font-semibold text-rose-600'>
                                    <MdError className='mr-2 inline-block align-middle' />
                                    Kami Sudah Mendapatkan Gambar Wajah Anda
                                </h1>
                            </div>
                        )}
                        {isLoading ? (
